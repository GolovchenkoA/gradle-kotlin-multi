...
public class VisibilityTutorialsJava {
    private final String kotlinPrivateField = "this field is private but when this class is compiled then " +
    ...
    String getKotlinPrivateField() {return kotlinPrivateField;}
}
